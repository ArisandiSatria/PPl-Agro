...
if (isset($_POST['submitCustomer'])) {
    ...
    $sql = "SELECT * FROM akun_customer WHERE e_mail='$email' AND password='$password'";
        ...
        <div class="container col row mt-5 mx-auto">
            <div class="col-6 mx-auto mt-5">
                <form action="" method="POST">
                    ...
                    <small class="fw-light"><p class="login-register-text">Anda belum punya akun? <a href="registerCustomer.php" >Register</a> atau masuk sebagai <a href="loginOwner.php" >Owner</a></p></small>
                </form>
            </div>
        </div>
    </div>
