...
<body>
    ...
    <div class="container mt-5">
        <h5 style="color: rgba(255, 117, 24, 1);">Ayo Beli!</h5>
        <h2 class="mb-4" style="font-weight: bold;">Ini yang kami tawarkan</h2>
            ...
            <div class="col">
                <div class="card h-100 border-0 rounded-3">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="detailProdukCustomer.php?id=<?=$a["id_produk"]?>" class="btn btn-warning" style="background-color: rgba(255, 117, 24, 1); color: white;" >Detail Produk</a>
                        </div>
                    </div>
                </div>
            </div>
